...
public class CreditOfferController {
    ...
    @FXML
    public void addClientOfferButtonAction(ActionEvent event) {
    	
    	if(checkFields()) {   		
    	
    		Client client = new Client(	surnameTextField.getText(), 
    		...
    		Credit credit = new Credit( client.getId(),
    		...
    		/**
    		 * Добавляем клиента и кредит в локальный список
    		 */
    		...
    		clientController.insertObject(client);
    		...
    		creditController.insertObject(credit);
